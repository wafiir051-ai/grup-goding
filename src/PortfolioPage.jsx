      ...
      <section className="relative pt-16 sm:pt-20 md:pt-24 pb-12 sm:pb-16 md:pb-20 px-4 sm:px-6 z-10">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center">
            ...
            >
              <div className="flex items-center gap-3 bg-white/90 backdrop-blur-md/90 backdrop-blur-md border border-gray-100 shadow-sm rounded-2xl px-3 sm:px-6 py-2 sm:py-3">
              ...
              <div className="flex items-center gap-3 bg-white/90 backdrop-blur-md/90 backdrop-blur-md border border-gray-100 shadow-sm rounded-2xl px-6 py-3">
        ...
        <div className="max-w-6xl mx-auto">
              ...
              {projects.map((project, idx) => (
                <RevealOnScroll key={project.id} customDelay={idx * 0.15}>
                  <motion.div
                    ...
                    className="bg-white/90 backdrop-blur-md/90 backdrop-blur-md border border-gray-100 hover:border-blue-200 rounded-3xl overflow-hidden shadow-md hover:shadow-2xl hover:shadow-blue-100 transition-all duration-300"
                  >
          ...
          <RevealOnScroll>
            <div className="mt-24 text-center rounded-3xl p-14 bg-gradient-to-br from-blue-600 to-cyan-500 relative overflow-hidden shadow-2xl shadow-blue-200">
              ...
              <div className="absolute -bottom-10 -right-10 w-64 h-64 bg-white/90 backdrop-blur-md/90 backdrop-blur-md/10 rounded-full blur-3xl" />
              <div className="relative z-10">
                <div className="inline-flex items-center gap-2 bg-white/90 backdrop-blur-md/90 backdrop-blur-md/20 border border-white/30 text-white text-sm font-semibold px-4 py-2 rounded-full mb-6">
                ...
                <button
                  ...
                  className="bg-white/90 backdrop-blur-md/90 backdrop-blur-md text-blue-600 font-bold px-10 py-4 rounded-2xl hover:scale-105 transition-all shadow-xl text-base"
                >
                  Mulai Sekarang
                </button>
              </div>
