...
export default function BentoServices() {
  ...
  return (
    <section id="services" style={{position:"relative"}} className="py-20 md:py-28 bg-white relative overflow-hidden px-4 sm:px-6">
      <SectionCanvas type="particles" opacity={0.35} />
            ...
            return (
              <RevealOnScroll key={s.id} componentName="services">
                <motion.div
                  ...
                  className={`${s.span} ${s.color} p-6 sm:p-7 md:p-8 lg:p-10 rounded-2xl md:rounded-3xl cursor-pointer shadow-md hover:shadow-xl transition-all`}
                >
