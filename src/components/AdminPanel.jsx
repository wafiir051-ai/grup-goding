...
export default function AdminPanel() {
  ...
  const handlePlanSubmit = async (e) => {
    ...
    const payload = { name: planForm.name, price: parseInt(planForm.price), period: planForm.period, description: planForm.description, features: featuresArray, tech_stack: techStackArray, popular: planForm.popular };
